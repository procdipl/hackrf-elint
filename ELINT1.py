...
import ELINT1_epy_block_0 as epy_block_0  # embedded python block
import osmosdr
import time
import sip
...
class ELINT1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ELINT1")
        ...
        self._freq_range = qtgui.Range(1e6, 6e9, 100e6, 1e6, 1000)
        ...
        self.osmosdr_source_0.set_gain(34, 0)
        self.osmosdr_source_0.set_if_gain(22, 0)
        self.osmosdr_source_0.set_bb_gain(22, 0)
        self.osmosdr_source_0.set_antenna('', 0)
        self.osmosdr_source_0.set_bandwidth(samp_rate, 0)
        self.epy_block_0 = epy_block_0.blk()
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("TEST"), 3000)
...
def main(top_block_cls=ELINT1, options=None):
